      ...
      startActionPane: ActionPane(
        ...
        children: [
          SlidableAction(
            onPressed: (context) async {
              if (student.id == null) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Student ID is missing. Cannot delete.')),
                );
                return;
              }
              ...
              AlertDialog alert = AlertDialog(
                ...
                content: const Text("Voulez-vous supprimer cet étudiant ?"),
                actions: [
                  TextButton(
            ...
            backgroundColor: const Color.fromARGB(255, 202, 33, 33),
